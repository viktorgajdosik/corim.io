...
<div class="sidebar">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="logout.php" class="list-group-item list-group-item-action <?php if (basename($_SERVER['PHP_SELF']) == 'logout.php') echo 'active'; ?>">
  ...
  <nav class=" navbar-light bg-white">
    <div class="container">
      <ul class="navbar-nav d-flex justify-content-between w-100">
        ...
        <li class="nav-item">
        <a class="nav-link <?php if (strpos($current_url, 'logout.php') !== false) { echo 'active'; } ?>" href="logout.php"><i class="fa fa-sign-out"></i></a>
        </li>
      </ul>
    </div>
  </nav>
